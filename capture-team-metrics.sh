...
main() {
    ...
    local ndjson_output="${OUTPUT_DIR}/copilot-team-metrics-${team_slug}-${target_date}.ndjson"
    local csv_output="${OUTPUT_DIR}/copilot-team-metrics-${team_slug}-${target_date}.csv"
